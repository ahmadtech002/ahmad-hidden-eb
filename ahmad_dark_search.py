...
# Search results categorized by theme
SEARCH_RESULTS = {
    "Whispers": [
...
def search_dark_realm(query):
    """Simulate searching the dark realm with animations and dynamic results."""
    # Easter eggs for specific queries
...
def main():
    """Main function to run the Dark Search program."""
    # Display the intro with ASCII art
    display_skull_intro()
